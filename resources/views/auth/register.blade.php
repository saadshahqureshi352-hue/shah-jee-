            ...
            <div x-show="step === 1" class="grid gap-6 lg:grid-cols-3">
                ...
                <section class="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 flex justify-end">
                        <button type="button" @click="step = 2" :disabled="!acceptedRules"
                                :class="acceptedRules ? 'bg-gradient-to-r from-orange-400 to-rose-500 hover:from-orange-500 hover:to-rose-600' : 'bg-slate-300 cursor-not-allowed'"
                                class="rounded-lg px-6 py-2.5 font-bold text-white shadow-md transition-all duration-300">
                            Next Step
                        </button>
                    </div>
                </section>
                ...
                <aside class="space-y-4">
                    ...
                    <a href="https://wa.me/923197290092?text=Assalam-o-Alaikum!%20I%20need%20help%20with%20Shipper%20Registration."
                       ...
                       class="flex items-center gap-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-green-600 p-4 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 animate-whatsapp">
