...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@2.6.0/dist/tabler-icons.min.css" />
    <style>
...
<script>
const titles={dashboard:'Dashboard',shippers:'Connected shippers',ledger:'Earnings ledger',transactions:'Transaction history',payouts:'Payout history',toolkit:'Referral toolkit',notifications:'Notifications',reports:'Reports & exports',profile:'My profile'};
function show(name,el){document.querySelectorAll('.panel').forEach(p=>p.classList.remove('active'));document.querySelectorAll('.nav-item').forEach(n=>n.classList.remove('active'));document.getElementById('panel-'+name).classList.add('active');document.getElementById('page-title').textContent=titles[name]||name;if(el&&el.classList)el.classList.add('active');}
</script>
</body>
</html>
