...
class Booking extends Model
{
    ...
    public const STATUS_READY_TO_RETURN = 'ready_to_return';
    ...
    public static function getStatusBadgeClass(string $status): string
    {
        return match ($status) {
            ...
            self::STATUS_READY_TO_RETURN => 'bg-w', // yellow-ish bucket
            self::STATUS_RETURN_CONFIRMED => 'bg-d', // returned final bucket
    ...
    public static function getStatusLabel(string $status): string
    {
        return match ($status) {
            ...
            self::STATUS_READY_TO_RETURN => 'Ready to Return',
            self::STATUS_RETURN_CONFIRMED => 'Return Confirmed',
